...
- `Auto separate firm week and balancing week`: keep the selected Target Week as the firm week, then automatically move the balancing week forward until the item is back within the healthy range.
"""
        )
...
with right:
    ...
    auto_balance_week = st.checkbox(
        ...
        value=False,
        help="If enabled, the app keeps the selected Target Week as the firm week, then automatically moves the balancing week forward week by week until every item has at least one warehouse at or below 150% SS% after optimization.",
    )
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        try:
            ...
            st.session_state["last_run_info"] = {
                ...
                "Auto separate firm and balancing week": auto_balance_week,
                **run_info,
            }
